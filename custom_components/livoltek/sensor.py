...
SENSORS = [
    ...
    LivoltekSensorEntityDescription(
        ...
        suggested_display_precision=1,
        enabled=lambda x: x.todays_grid is not None and x.todays_grid.get("positive") is not None,
        value_fn=lambda x: float(x.todays_grid["positive"]) if x.todays_grid and x.todays_grid.get("positive") is not None else None,
    ),
    LivoltekSensorEntityDescription(
        ...
        state_class=SensorStateClass.TOTAL_INCREASING,
        suggested_display_precision=1,
        enabled=lambda x: x.todays_grid is not None and x.todays_grid.get("negative") is not None,
        value_fn=lambda x: float(x.todays_grid["negative"]) if x.todays_grid and x.todays_grid.get("negative") is not None else None,
    ),
    LivoltekSensorEntityDescription(
        ...
        state_class=SensorStateClass.TOTAL_INCREASING,
        suggested_display_precision=1,
        enabled=lambda x: x.todays_solar is not None and x.todays_solar.get("powerGeneration") is not None,
        value_fn=lambda x: float(x.todays_solar["powerGeneration"])
        if x.todays_solar and x.todays_solar.get("powerGeneration") is not None
        else None,
    ),
]
